...
def get_single_group(group_id: int, service: GroupService = Depends(get_group_service)):
    return service.get_single_group(group_id)
...
def update_group(
    ...
    return service.update_group(group_id, update_request)
